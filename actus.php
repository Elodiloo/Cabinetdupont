...
<body>
    ...
    <main>
        ...
        <div id="actu1" class="icon-container border">
            <div class="col-25">
                <img src="img/bruxisme.png" alt="dupont" class="image-radius">
            </div>
            <div class="col-75">
                <h2 class="text-center">Bruxisme : tout savoir avant de consulter !</h2>
                <h3>Le grincement des dents et le serrage de mâchoire sont souvent liés au stress ou à l’anxiété. Cela
                    ne provoque pas toujours de symptômes, mais certaines personnes ressentent des douleurs au visage et
                    des maux de tête.</h3>
            </div>
        </div>

        <div id="actu2" class="icon-container2 border2">
            <div class="col-25">
                <img src="img/mutuelle.png" alt="dupont" class="image-radius">
            </div>
            <div class="col-75">
                <h2 class="text-center">Évaluation du coût des mutuelles dentaires pour seniors : une analyse financière
                </h2>
                <h3>Les seniors, constituant la population âgée de 55 ans et plus, rencontrent des défis uniques
        ...
        <div id="actu3" class="icon-container3 border">
            <div class="col-25">
                <img src="img/ortho.png" alt="dupont" class="image-radius">
            </div>
            <div class="col-75">
                <h2 class="text-center">Pourquoi consulter un orthodontiste ?</h2>
                <h3>L’orthodontie est une médecine dentaire visant à corriger les défauts dentaires tels qu’un mauvais
